...
df['Bear'] = (df['Close'] < df['200 EMA']) & (df['Close'] < df['200 SMA'])
...
df['Sell exit'] = ((df['%K'] > df['%D']) & (df['%K'].shift(1) < df['%D'].shift(1)) & df['%K']>50) 
...
df['Bull'] = (df['Close'] > df['200 EMA']) & (df['Close'] > df['200 SMA'])
...
df['Buy exit'] = ((df['%K'] < df['%D']) & (df['%K'].shift(1) > df['%D'].shift(1)) & df['%K']<50) 
